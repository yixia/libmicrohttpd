...
ACLOCAL = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/missing --run autoconf
AUTOHEADER = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/missing --run autoheader
AUTOMAKE = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/missing --run makeinfo
MANIFEST_TOOL = :
MHD_LIBDEPS = 
...
PACKAGE_STRING = libmicrohttpd 0.9.26
...
VERSION = 0.9.26
_libcurl_config = 
abs_builddir = /home/le/workspace/libmicrohttpd-0.9.26
abs_srcdir = /home/le/workspace/libmicrohttpd-0.9.26
abs_top_builddir = /home/le/workspace/libmicrohttpd-0.9.26
abs_top_srcdir = /home/le/workspace/libmicrohttpd-0.9.26
ac_ct_AR = ar
ac_ct_CC = gcc
...
install_sh = ${SHELL} /home/le/workspace/libmicrohttpd-0.9.26/install-sh
...
pdfdir = ${docdir}
prefix = /home/le/workspace/libmicrohttpd-0.9.26/build/android
